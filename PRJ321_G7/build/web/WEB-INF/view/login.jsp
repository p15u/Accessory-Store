...
<body>
                            ...
                            <div class="_3pDA7Q">
                                <form action="login" method="POST">
                                    <div class="_7p8xth">
                                        <div class="F6pUq_">
                                            <div class="_1x1Hdu">
                                                <div class="_38VpOh">Login</div>
                                                <div>
                                                    <span class="_1g_VZh">Don't have an account?</span>
                                                    <a class="_158uwD" href="register.html">Register</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="_1B7mke">
                                            ...
                                            <div class="_1HkukX">
                                                <div class="FcG1bN">
                                                    <input name="txtUser" id="input-user" class="_56AraZ" type="text" placeholder="Your username" autocomplete="on" name="loginKey" maxlength="50" value="">
                                                </div>
                                                <div class="_1pHauM"></div>
                                            </div>
                                            <div class="_3Uo2e7">
                                                <div class="FcG1bN">
                                                    <input name="txtPass" id="input-pass" class="_56AraZ" type="password" placeholder="Your password" autocomplete="current-password" name="password" maxlength="16" value="">
                                            ...
                                            <button name="act" id="btn-login" class="_25c6dS _2revuH CCz-NV _3LF8FC _1YKfmR E73q_w" disabled="">LOGIN</button>
                                            <div class="QnCMt9">
                                                <a class="O64rDC" href="index.html">Return to home</a>
                                                <a class="O64rDC" href="#">Forgot password</a>
                                            </div>
                                            <div id="login-fail" class="uud8ko qluhEI" style="display: none;">
                                                <div class="_1LQvwM">
                                                ...
                                                <div class="_2d8JQY">Wrong username or password!</div> 
                                            </div>
                                            <div>
                                                <div class="_1H97P4">
                                                ...
                                                <div class="_1p6-r9">
                                                    <button name="act" value="fb" class="_25c6dS _2revuH _3Bn0WQ WEKQ8O _1lANZ5">
                                                        <div class="_2RF1Ts">
                                                            <div class="_3ToC_U social-white-background social-white-fb-png"></div>   
                                                        </div>
                                                        <div class="_11sJwN _1trMER">Facebook</div>
                                                    </button>
                                                    <button name="act" value="gg" class="_25c6dS _2revuH _3Bn0WQ WEKQ8O a6g9DN">
                                                        <div class="_2RF1Ts _1-atte">
                                                            <div class="_3X-VvE social-white-background social-white-google-png"></div>
                                                        </div>
                                                        <div class="_11sJwN">Google</div>
                                                    </button>
                                                </div>
                                            </div>
                                            <br>
                                            <div id="login-social-fail" class="uud8ko qluhEI" style="display: none;">
                                                <div class="_1LQvwM">
                                                    <svg class="stardust-icon stardust-icon-cross-with-circle _2Kw8rR" viewBox="0 0 16 16"><defs></defs>
                                                        <path fill="none" stroke="#FF424F" d="M8 15A7 7 0 108 1a7 7 0 000 14z" clip-rule="evenodd"></path>
                                                        <rect stroke="none" width="7" height="1.5" x="6.061" y="5" fill="#FF424F" rx=".75" transform="rotate(45 6.06 5)"></rect>
                                                ...
                                                <div class="_2d8JQY">Cannot connect to your social network account!</div> 
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    <script type="text/javascript">
        ...
        inputUser.oninput = inputPass.oninput = function() {
            var user = inputUser.value;
            var pass = inputPass.value;
            btnLogin.disabled = user === '' || pass === '';
        };
    </script>
</body>
</html>